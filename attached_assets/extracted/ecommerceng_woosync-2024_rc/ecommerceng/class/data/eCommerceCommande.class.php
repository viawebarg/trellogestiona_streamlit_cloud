...
class eCommerceCommande
{
	...
	//public $element='ecommerce_commande.sql';			//!< Id that identify managed objects
	//public $table_element='ecommerce_commande.sql';	//!< Name of table without prefix where object is stored
