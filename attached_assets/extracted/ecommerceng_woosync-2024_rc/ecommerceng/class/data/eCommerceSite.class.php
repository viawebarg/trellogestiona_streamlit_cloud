...
class eCommerceSite // extends CommonObject
{
	 ...
	 * @return  void
	 */
	public function cleanOrphelins()
	{
	 ...
	 * @return  void
	 */
	public function cleanDuplicatesRemoteID()
	{
		$stopwatch_id = eCommerceUtils::startAndLogStopwatch(__METHOD__);
		$ids = array();
	 ...
	 */
	public function listSites($mode='array', $all_entity = false)
	{
		$list = array();
	 ...
	 */
	public function hasTypeSite($typeSite)
	{
		$sql = "SELECT";
		$sql .= " count(*) AS count";
		$sql .= " FROM " . MAIN_DB_PREFIX . "ecommerce_site as t";
